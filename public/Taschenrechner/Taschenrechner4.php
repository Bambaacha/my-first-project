...
<body>
	<form action="Taschenrechner4.php" method="post">
		...
		<table>
				...
				<td>
					<select name="selectList" size="10">
						...
						if(isset($_POST['btnBerechnen']))
						{
							...
							{
								if(isset($_SESSION['selectOperator']['optAdd']))
								{
									$_POST['txtErgebnis'] = $_POST['txtOp1'] + $_POST['txtOp2'];
									return $_POST['txtErgebnis'];
								}
								else if(isset($_POST['optSub']))
								{
									$_POST['txtErgebnis'] = $_POST['txtOp1'] - $_POST['txtOp2'];
								}
								else if(isset($_POST['optMul']))
								{
									$_POST['txtErgebnis'] = $_POST['txtOp1'] * $_POST['txtOp2'];
								}
								else if(isset($_POST['optDiv']))
								{
									$_POST['txtErgebnis'] = $_POST['txtOp1'] / $_POST['txtOp2'];
								}
			...
			<tr>
				...
				<td>
					<select name="selectOperator" size="1">
						<option name="optAdd">+</option>
						<option name="optSub">-</option>
						<option name="optMul">*</option>
						<option name="optDiv">/</option>
					</select>
